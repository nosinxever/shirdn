// app/api/create-wishs-database/route.js
import { createWishsDatabase, getDatabasesFromPage} from "@/lib/notionServer";
...
export async function POST(request) {
    ...
    try {
        const response = await createWishsDatabase(parentId)
